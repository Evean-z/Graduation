...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main">
            <div class="admin-login-box">
                <a class="logo" style="left: 0;" href="#">
                    <span style="font-size: 22px;">财务报销管理系统</span>
                </a>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    <a href="${pageContext.request.contextPath}/user/allUser">用户管理</a>
                </li>
                <li class="layui-nav-item">
                    <a href="${pageContext.request.contextPath}/message/allMsg">信息管理</a>
                </li>
                <li class="layui-nav-item">
                    <a href="">云市场</a>
                </li>
    ...
    <div class="layui-footer footer footer-demo" id="admin-footer">
        <div class="layui-main">
            <p>2021 &copy;
                <a href="#">Financial reimbursement management system</a>
            </p>
        </div>
    </div>
